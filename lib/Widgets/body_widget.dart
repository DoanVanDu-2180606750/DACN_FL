...
class BodyWidgets {
  ...
  static Widget saveButton(BuildContext context, TextEditingController heightController, TextEditingController weightController) {
    return ElevatedButton(
      onPressed: () async {
        ...
        // Fetch AI advice
        await Provider.of<BodyProvider>(context, listen: false).fetchAIAdvice(height, weight);
  ...
  static Widget aiAdviceSection(BuildContext context) {
